...
The total waiting times, which include censored observations, are stored in different variables and need to be consolidated into a single variables for the analysis.
```{r}
